...
| feedback-svn-commit-一律先問使用者確認-計畫核准不等於上版授權 | memory/Failures/版控/SVN/feedback-svn-commit-一律先問使用者確認-計畫核准不等於上版授權.md | svn commit, 上SVN, 上版, commit 授權, 計畫核准, ExitPlanMode, 驗證完就上, 不先問就 commit, 上傳必經明確授權, svn status, sgi_server, sgi_client, Tools/, 順手修, 同事回報, 文件修正, README, 註解, SVN 資料夾 | global |
