...
- Related: handoff-綜觀品質與抗失真寫法, feedback-workflow-discipline, decisions-architecture, cognitive-patterns, decisions, realm-範疇分區機制-v5, 跨session協調-衝突預警機制與cc原生現況, feedback-整理歸檔任務-狀態變更即決策-活項對照閘-方向不明動手前先問, pan-hermes不移植部件與vscode-text-block不落盤實測, 並行llm即時通訊-inbox機制, 壓縮後根層-claudemd-由磁碟重讀不需自製-constraint-pinning-真正會丟的是對話中的計畫脈絡-用-staging-計畫檔加-sessionstart-resume-指標接續
