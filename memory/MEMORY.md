...
- feedback-completion-gates — pytest 必跑 / smoke / 研究先行 / xfail 標記
...
## V5 升版（2026-05 進行中）
- v5-overhaul-audit-2026-05 — 4-Wave 計畫 + handoff atom

> **知識庫**：`_AIDocs/{ClaudeCodeInternals,Tools,Failures}/_INDEX.md`
