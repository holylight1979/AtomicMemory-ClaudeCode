...
│   ├── _atom_index.json                            ← V5 JSON SoT（<!-- atom-breakdown -->68 atoms：core 18 + feedback 10 + 失敗模式 2 + local 38〔World4/Tools9/MemDev19/OS3/Continuity2/Vision1〕<!-- /atom-breakdown -->）
