...
│   ├── _atom_index.json                            ← V5 JSON SoT（<!-- atom-breakdown -->71 atoms：core 18 + feedback 10 + 失敗模式 2 + local 41〔World4/Tools10/MemDev21/OS3/Continuity2/Vision1〕<!-- /atom-breakdown -->）
