...
- [臨] 晉升閘=真實 Confirmations 主軌 OR 效用 Wilson 下界（升≥promote_lb 0.6 且 n≥min_n 3，z=wilson_z 1.28）；**ReadHits 退出晉升、降為純曝光計數**（取代 Phase 0 過渡）。降級候選≤demote_lb 0.35,n≥3 列 staging 報告不自動降。慢衰減 λ=0.97（SessionEnd _self_iterate_atoms）α←1+λ(α−1)。
