...
- Related: escalation-hook-在-edit-count-proxy-上-false-fire-的辨識無真實失敗迴圈時不盲從不編造, decisions-architecture
...
- [臨] budget 上限有時 750/1750/2550 非 bug：compute_token_budget 按 prompt 長度給 1000/2000/3000 起始額，build_context 逐段扣減（session context −200、JIT −250）後才是尾行分母。
