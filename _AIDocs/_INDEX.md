...
| 6 | DocIndex-System.md | 全檔系統索引（啟動鏈 + Hook 模組 + 23 Skills + Tools + Memory 48 atoms：core 14 + feedback 7 + 失敗 2 + local 25） | 啟動鏈, lifecycle, 全檔索引, 檔案清單, 系統索引, realm, local atom |
