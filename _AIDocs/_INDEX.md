...
| 6 | DocIndex-System.md | 全檔系統索引（啟動鏈 + Hook 模組 + <!-- skill-count -->23<!-- /skill-count --> Skills + Tools + Memory <!-- atom-breakdown -->54 atoms：core 15 + feedback 8 + 失敗模式 2 + local 29〔World4/Tools11/MemDev9/OS3/Continuity2〕<!-- /atom-breakdown -->） | 啟動鏈, lifecycle, 全檔索引, 檔案清單, 系統索引, realm, local atom |
