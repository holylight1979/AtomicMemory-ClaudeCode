...
- Related: decisions, feedback-rigor-standards, cc-能力查證反編譯實跑-binary, windows-cc-hook-閃-console-pythonw-修-layer-1勿只補巢狀-creationflags, 對談結束自動記憶與錯誤加權深記, feedback-complexity-origin-trace, feedback-未實證先別斷言-從根源驗證-先證再修-反退避反冗長, 記憶汙染與上下文腐化-注入萃取自檢, escalation-hook-在-edit-count-proxy-上-false-fire-的辨識無真實失敗迴圈時不盲從不編造
